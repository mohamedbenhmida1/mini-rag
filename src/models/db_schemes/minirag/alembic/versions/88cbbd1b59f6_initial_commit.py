...
Revision ID: 88cbbd1b59f6
Revises: 
Create Date: 2026-05-14 11:14:46.933563
...
def upgrade() -> None:
    ...
    op.create_index('ix_chunks_asset_id', 'chunks', ['chunk_asset_id'], unique=False)
    op.create_index('ix_chunks_project_id', 'chunks', ['chunk_project_id'], unique=False)
